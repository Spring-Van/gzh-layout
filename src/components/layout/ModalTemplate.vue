    ...
    >
      ...
      <div class="p-6">
        <p class="text-sm text-slate-500 mb-4">
          这里可以自行编写 HTML 或注入自定义 CSS 样式表。
        </p>
        <div
          class="border border-slate-200 rounded-lg p-4 bg-slate-50 flex items-center justify-center h-32 mb-4 text-sm text-slate-400 border-dashed"
        >
          [开发中] 模板代码可视化编辑器
        </div>
        <button
          class="w-full border border-dashed border-slate-300 text-sm text-slate-600 py-2 rounded-lg hover:bg-slate-50 transition"
        >
          + 导入外部模板文件
        </button>
      </div>
