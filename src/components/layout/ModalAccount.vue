  ...
  >
    ...
    >
      ...
      <div class="p-6 space-y-4">
        <div
          class="bg-green-50 border border-green-100 p-3 rounded-lg flex items-center gap-3"
        >
          <div
          ...
          <div>
            <div class="text-sm font-bold text-green-800">
              当前活跃账号：{{ activeAccount?.nickname || "壁纸情报局" }}
            </div>
      ...
      <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex gap-3">
        ...
        <button
          class="flex-1 px-4 py-2 text-sm bg-primary text-white rounded hover:bg-primary-hover transition"
          @click="handleSave"
        >
          保存并关闭
        </button>
