    ...
    <div class="flex min-h-0 flex-1 flex-col overflow-hidden p-3">
      <div class="min-h-0 flex-1 rounded-xl border border-border-subtle bg-surface p-4 shadow-sm shadow-black/10">
        <textarea
          ...
          placeholder="一页一块，一格一行，行序即页序：&#10;①【镜头】本格画面内容。&#10;说话人：【本格台词】&#10;②【镜头】本格画面内容。&#10;（台词 / 旁白正文用【】括起、说话人在【】外：对白「说话人：【台词】」；内心独白「说话人（心声）：【…】」；画面外「说话人（画外）：【…】」；无人称用「旁白：【…】」）"
          @blur="commitDraft"
        />
 ...
 * 主体为当前分镜的**单一文本编辑框**，内容即页块文本（`①【镜头】画面` + `说话人：【台词】`
 * + `旁白：【文字】`，台词 / 旁白正文带【】、说话人在【】外），与模型输出、可复制格式完全一致——所见即所得，失焦或切换分镜自动保存。
 * 底部为**本页操作**（与「提示词」模式的「单镜操作」同款卡片），只保留 AI 优化
 * （按分镜协议规整这一页：补镜头 / 拆超长台词 / 补说话人，不改剧情与台词文字）。
